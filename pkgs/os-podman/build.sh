...
install -m 0755 "${SCRIPT_DIR}/src/usr/local/etc/rc.d/podman" \
    "${DIST_ROOT}/dist/pkg/usr/local/etc/rc.d/podman"
...
chmod 0755 "${DIST_ROOT}/dist/pkg/usr/local/etc/rc.d/podman"
